...
# what are the rows...?
# the row are patients
# unstranded: 
# Hint: Do the rows/cols match dimensions of other dataframes? yes
...
# unstranded, stranded_first, stranded_second, tpm_unstrand, fpkm_unstranded, and fpkm_uq_unstrand
```{r Exercise 4.1}
